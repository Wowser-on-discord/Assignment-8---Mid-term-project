            ...
            <div class="container-fluid">
                <?php
                    ...
                    if (isset($_SESSION['username'])) {
                        ...
                        echo "<br>";
                        echo "Welcome, $username! Here you can design your profile or make any changes to it! <br><br>";
                    } else {
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        header("Location: profiles.php?username=" . $username);
                        exit();
                    }
                ?>
                ...
                <!-- Your form for updating the user's profile data -->
                <form action="dynamicaccount.php" method="POST" enctype="multipart/form-data">
                    <!-- Hidden field to store the user ID -->
                    <input type="hidden" name="username" value="<?php echo $username; ?>"> 

                    <!-- Your form fields for updating the profile -->
                    <div class="mb-3">
